...
class CrawlableEntity(Notifier):
    link: str
    name: str
...
company = Company(employees_min=1, employees_max=10, link='', name='')
event = Event(start_date='', link='', name='')
test_obj = CompanyForEvent(event=event, company=company)
test_obj.company.is_deleted = True
